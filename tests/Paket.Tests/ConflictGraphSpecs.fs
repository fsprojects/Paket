...
let ``should analyze graph and report conflict``() = 
    ...
    let conflict = 
        FromPackage { Defining = 
                          { Name = "B"
                            VersionRange = Exactly "1.1"
                            SourceType = ""
                            Source = "" }
                      Referenced = 
                          { Name = "D"
                            VersionRange = Exactly "1.4"
                            SourceType = ""
                            Source = "" } }, 
        FromPackage { Defining = 
                          { Name = "C"
                            VersionRange = Exactly "2.4"
                            SourceType = ""
                            Source = "" }
                      Referenced = 
                          { Name = "D"
                            VersionRange = Exactly "1.6"
                            SourceType = ""
                            Source = "" } }
