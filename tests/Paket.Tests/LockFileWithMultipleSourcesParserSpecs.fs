module Paket.LockFileWithMultipleSourcesParserSpecs
...
let ``should parse lockfile``() = 
    ...
    result.[4].SourceType |> shouldEqual Nuget
    result.[4].Source |> shouldEqual "http://nuget.org/api/v3"
    ...
    result.[5].Source |> shouldEqual "http://nuget.org/api/v3"
