...
let ``should find castle.core alone``() =
    ...
    getVersion resolved.[NormalizedPackageName (PackageName "Castle.Core")] |> shouldEqual "3.2.2"
    resolved.ContainsKey(NormalizedPackageName (PackageName "Castle.Windsor")) |> shouldEqual false
