...
let defaultPackage = { Name = ""; IsRoot = true; VersionRequirement = VersionRequirement(VersionRange.Exactly "1.0",PreReleaseStatus.No); Sources = [PackageSource.NugetSource ""]; ResolverStrategy = ResolverStrategy.Max }
