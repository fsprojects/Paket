...
let graph = 
    [ "A", "1.0", 
      [ "B", VersionRequirement.New(VersionRange.Exactly "1.1",PreReleaseStatus.No)
        "C", VersionRequirement.New(VersionRange.Exactly "2.4",PreReleaseStatus.No) ]
      "B", "1.1", 
      [ "E", VersionRequirement.New(VersionRange.Exactly "4.3",PreReleaseStatus.No)
        "D", VersionRequirement.New(VersionRange.Exactly "1.4",PreReleaseStatus.No) ]
      "C", "2.4", 
      [ "F", VersionRequirement.New(VersionRange.Exactly "1.2",PreReleaseStatus.No)
        "D", VersionRequirement.New(VersionRange.Exactly "1.6",PreReleaseStatus.No) ]
      "D", "1.4", []
      "D", "1.6", []
      "E", "4.3", []
      "F", "1.2", [] ]
...
let defaultPackage = 
    { Name = PackageName ""
      ...
      VersionRequirement = VersionRequirement.New(VersionRange.Exactly "1.0", PreReleaseStatus.No)
...
let graph2 = 
    [ "A", "1.0", 
      [ "B", VersionRequirement.New(VersionRange.Exactly "1.1",PreReleaseStatus.No)
        "C", VersionRequirement.New(VersionRange.Exactly "2.4",PreReleaseStatus.No) ]
      "B", "1.1", [ "D", VersionRequirement.New(VersionRange.Between("1.4", "1.5"),PreReleaseStatus.No) ]
      "C", "2.4", [ "D", VersionRequirement.New(VersionRange.Between("1.6", "1.7"),PreReleaseStatus.No) ]
      "D", "1.4", []
      "D", "1.6", [] ]
