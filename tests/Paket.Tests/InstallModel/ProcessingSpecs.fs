...
let ``should create empty model with net40, net45 ...``() = 
    ...
    model.GetFrameworks() |> shouldContain (DotNetFramework(FrameworkVersion.V4, Full))
    model.GetFrameworks() |> shouldContain (DotNetFramework(FrameworkVersion.V4_5, Full))

[<Test>]
let ``should understand net40 and net45``() = 
    let model = emptymodel.AddReferences [ @"..\Rx-Main\lib\net40\Rx.dll"; @"..\Rx-Main\lib\net45\Rx.dll" ] 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Rx-Main\lib\net40\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Rx-Main\lib\net45\Rx.dll"
...
let ``should add net35 if we have net20 and net40``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Rx-Main\lib\net20\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldContain @"..\Rx-Main\lib\net20\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Rx-Main\lib\net40\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldNotContain @"..\Rx-Main\lib\net20\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Rx-Main\lib\net40\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5_1, Full)) |> shouldContain @"..\Rx-Main\lib\net40\Rx.dll"
...
let ``should skip buckets which contain placeholder while adjusting upper versions``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldContain @"..\Rx-Main\lib\net20\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldNotContain @"..\Rx-Main\lib\net20\Rx.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldNotContain @"..\Rx-Main\lib\net20\Rx.dll"
...
let ``should filter _._ when processing blacklist``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldNotContain @"..\Rx-Main\lib\net20\_._"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldNotContain @"..\Rx-Main\lib\net40\_._"
...
let ``should install single client profile lib for everything``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldNotContain @"..\Castle.Core\lib\net40-client\Castle.Core.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Client)) |> shouldContain @"..\Castle.Core\lib\net40-client\Castle.Core.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Castle.Core\lib\net40-client\Castle.Core.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Castle.Core\lib\net40-client\Castle.Core.dll"
...
let ``should handle lib install of Microsoft.Net.Http for .NET 4.5``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldNotContain @"..\Microsoft.Net.Http\lib\net40\System.Net.Http.dll"

    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Microsoft.Net.Http\lib\net40\System.Net.Http.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Microsoft.Net.Http\lib\net40\System.Net.Http.Primitives.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Microsoft.Net.Http\lib\net40\System.Net.Http.WebRequest.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldNotContain @"..\Microsoft.Net.Http\lib\net40\System.Net.Http.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Microsoft.Net.Http\lib\net45\System.Net.Http.Primitives.dll" 
...
let ``should handle lib install of Jint for NET >= 40 and SL >= 50``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldNotContain @"..\Jint\lib\portable-net40+sl50+win+wp80\Jint.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Jint\lib\portable-net40+sl50+win+wp80\Jint.dll"
...
let ``should handle lib install of Microsoft.BCL for NET >= 40``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldNotContain  @"..\Microsoft.Bcl\lib\net40\System.IO.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Microsoft.Bcl\lib\net40\System.IO.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Microsoft.Bcl\lib\net40\System.Runtime.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Microsoft.Bcl\lib\net40\System.Threading.Tasks.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldBeEmpty
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5_1, Full)) |> shouldBeEmpty
...
let ``should handle lib install of DotNetZip 1.9.3``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\DotNetZip\lib\net20\Ionic.Zip.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldContain @"..\DotNetZip\lib\net20\Ionic.Zip.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\DotNetZip\lib\net20\Ionic.Zip.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\DotNetZip\lib\net20\Ionic.Zip.dll"
...
let ``should handle lib install of Fantomas 1.5``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Fantomas\lib\FSharp.Core.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldContain @"..\Fantomas\lib\FSharp.Core.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Fantomas\lib\FSharp.Core.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Fantomas\lib\FSharp.Core.dll" 
...
let ``should handle lib install of Fantomas 1.5.0 with explicit references``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldNotContain @"..\Fantomas\lib\FSharp.Core.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V3_5, Full)) |> shouldNotContain @"..\Fantomas\lib\FSharp.Core.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldNotContain @"..\Fantomas\lib\FSharp.Core.dll" 

    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldNotContain @"..\Fantomas\lib\FSharp.Core.dll" 
...
let ``should only handle dll and exe files``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Fantomas\lib\FantomasLib.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Fantomas\lib\FSharp.Core.dll" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldContain @"..\Fantomas\lib\Fantomas.exe" 
    model.GetFiles(DotNetFramework(FrameworkVersion.V2, Full)) |> shouldNotContain @"..\Fantomas\lib\FantomasLib.xml" 
...
let ``should use portable net40 in net45 when don't have other files``() = 
    ...
    model.GetFiles(DotNetFramework(FrameworkVersion.V4, Full)) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5, Full)) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5_1, Full)) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5_2, Full)) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
    model.GetFiles(DotNetFramework(FrameworkVersion.V4_5_3, Full)) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
