...
let emptymodel = InstallModel.EmptyModel(PackageName "Unknown",SemVer.Parse "0.1",InstallModelKind.Package)
...
let ``should create empty model with net40, net45 ...``() = 
    ...
    targets |> shouldContain (TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4))
    targets |> shouldContain (TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5))
...
let ``should understand reference folder``() =
    ...
    let refs =
        model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetStandard DotNetStandardVersion.V1_6))
    ...
    let refs =
        model.GetCompileReferences(TargetProfile.SinglePlatform (DotNetStandard DotNetStandardVersion.V1_6))
        |> Seq.map (fun f -> f.Path)
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\runtimes\win\lib\net46\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\lib\net35\System.Security.Cryptography.Algorithms.dll"
    ...
    let refs =
        model.GetCompileReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V3_5))
        |> Seq.map (fun f -> f.Path)
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\runtimes\win\lib\net46\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldContain @"..\System.Security.Cryptography.Algorithms\lib\net35\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\ref\netstandard1.6\System.Security.Cryptography.Algorithms.dll"
    ...
    let refs =
        model.GetCompileReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4))
        |> Seq.map (fun f -> f.Path)
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\runtimes\win\lib\net46\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldContain @"..\System.Security.Cryptography.Algorithms\lib\net35\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\ref\netstandard1.6\System.Security.Cryptography.Algorithms.dll"
    ...
    let refs =
        model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_6_3))
        |> Seq.map (fun f -> f.Path)
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\runtimes\win\lib\net46\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldContain @"..\System.Security.Cryptography.Algorithms\lib\netstandard1.5\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\ref\netstandard1.5\System.Security.Cryptography.Algorithms.dll"
    ...
    let refs =
        model.GetCompileReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_6_3))
        |> Seq.map (fun f -> f.Path)
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\runtimes\win\lib\net46\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\lib\netstandard1.5\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldContain @"..\System.Security.Cryptography.Algorithms\ref\netstandard1.5\System.Security.Cryptography.Algorithms.dll"
    ...
    let refs =
        model.GetRuntimeAssemblies RuntimeGraph.Empty (Rid.Of "win") (TargetProfile.SinglePlatform (DotNetStandard DotNetStandardVersion.V1_6))
    ...
    let refs =
        model.GetRuntimeAssemblies RuntimeGraph.Empty (Rid.Of "win") (TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_6_3))
        |> Seq.map (fun f -> f.Library.Path)
    ...
    let refs =
        model.GetRuntimeAssemblies RuntimeGraph.Empty (Rid.Of "unix") (TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_6_3))
        |> Seq.map (fun f -> f.Library.Path)
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\runtimes\win\lib\net46\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldContain @"..\System.Security.Cryptography.Algorithms\lib\netstandard1.5\System.Security.Cryptography.Algorithms.dll"
    refs |> shouldNotContain @"..\System.Security.Cryptography.Algorithms\ref\netstandard1.5\System.Security.Cryptography.Algorithms.dll"
...
let ``should understand aot in runtimes``() = 
    ...
    let refs =
        model.GetRuntimeAssemblies RuntimeGraph.Empty (Rid.Of "aot") (TargetProfile.SinglePlatform (DotNetStandard DotNetStandardVersion.V1_6))
        |> Seq.map (fun f -> f.Library.Path)
...
let ``should add net35 if we have net20 and net40``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\Rx-Main\lib\net40\Rx.dll"
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5_1))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\Rx-Main\lib\net40\Rx.dll"
...
let ``should handle lib install of Jint for NET >= 40 and SL >= 50``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (Silverlight SilverlightVersion.V5))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\Jint\lib\portable-net40+sl50+win+wp80\Jint.dll"
...
let ``should handle lib install of Microsoft.BCL for NET >= 40``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5)) |> shouldBeEmpty
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5_1)) |> shouldBeEmpty
...
let ``should handle lib install of NUnit 2.6 for windows 8``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\NUnit\lib\nunit.framework.dll"
    model.GetLegacyReferences(TargetProfile.SinglePlatform (Windows WindowsVersion.V8))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\NUnit\lib\nunit.framework.dll"
...
let ``should handle lib install of Microsoft.Net.Http 2.2.28``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (MonoAndroid MonoAndroidVersion.V1))
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform MonoTouch)
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (WindowsPhoneApp WindowsPhoneAppVersion.V8_1))
...
let ``should handle lib install of MicrosoftBcl``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (MonoAndroid MonoAndroidVersion.V1)) |> shouldBeEmpty
    model.GetLegacyReferences(TargetProfile.SinglePlatform MonoTouch) |> shouldBeEmpty
    model.GetLegacyReferences(TargetProfile.SinglePlatform (Windows WindowsVersion.V8)) |> shouldBeEmpty
    model.GetLegacyReferences(TargetProfile.SinglePlatform (WindowsPhone WindowsPhoneVersion.V8)) |> shouldBeEmpty
    model.GetLegacyReferences(TargetProfile.SinglePlatform (WindowsPhoneApp WindowsPhoneAppVersion.V8_1)) |> shouldBeEmpty
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (Silverlight SilverlightVersion.V4))
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (WindowsPhone WindowsPhoneVersion.V7_5))
...
let ``should use portable net40 in net45 when don't have other files``() = 
    ...
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5_1))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5_2))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
    model.GetLegacyReferences(TargetProfile.SinglePlatform (DotNetFramework FrameworkVersion.V4_5_3))
        |> Seq.map (fun f -> f.Path) |> shouldContain @"..\Google.Apis.Core\lib\portable-net40+sl50+win+wpa81+wp80\Google.Apis.Core.dll"
...
let ``should filter .NET 4.0 dlls for System.Net.Http 2.2.8``() = 
    ...
    let model =
        InstallModel.CreateFromLibs
            (PackageName "System.Net.Http", SemVer.Parse "2.2.8", InstallModelKind.Package,
...
let ``should filter properly when portables are available``() = 
    let model =
        InstallModel.CreateFromLibs
            (PackageName "Newtonsoft.Json", SemVer.Parse "8.0.3", InstallModelKind.Package,
             FrameworkRestriction.NoRestriction,
    ...
    filteredModel.GetLegacyReferences(TargetProfile.SinglePlatform(DotNetFramework(FrameworkVersion.V4_5)))
    |> Seq.map (fun f -> f.Path)
    |> Seq.toList
    |> shouldEqual [ @"..\Newtonsoft.Json\lib\net45\Newtonsoft.Json.dll" ]

    filteredModel.GetLegacyReferences(TargetProfile.SinglePlatform(DotNetFramework(FrameworkVersion.V4)))
    |> Seq.toList
    |> shouldEqual [ ]
...
let ``should keep net20 if nothing better is available``() = 
    let model =
        InstallModel.CreateFromLibs
            (PackageName "EPPlus", SemVer.Parse "4.0.5", InstallModelKind.Package,
             FrameworkRestriction.NoRestriction,
    ...
    filteredModel.GetLegacyReferences(TargetProfile.SinglePlatform(DotNetFramework(FrameworkVersion.V4_6_1)))
    |> Seq.map (fun f -> f.Path)
    |> Seq.toList
