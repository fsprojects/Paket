...
<configuration>
</configuration>"""  |> trimAndNormalizeLines
...
<?xml version="1.0" encoding="utf-8"?>
<configuration>
<runtime><assemblyBinding xmlns="%s">%s</assemblyBinding></runtime></configuration>""" bindingNs (createBindingRedirectXml "cul" "asm" "v" "pKey") |> trimAndNormalizeLines |> XDocument.Parse
...
</assemblyBinding></runtime></configuration>"""  |> trimAndNormalizeLines

        // Assert
        doc.ToString(SaveOptions.DisableFormatting)
        |> trimAndNormalizeLines
