...
<Choose xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <When Condition="$(TargetFrameworkIdentifier) == '.NETPortable'">
    <Choose>
      ...
      <When Condition="$(TargetFrameworkProfile) == 'net45+win8' And $(TargetPlatformIdentifier) == 'Portable' And $(TargetPlatformVersion) == '7.0'"></When>
      <Otherwise>
        <ItemGroup>
          <Reference Include="System.Net.Http.Extensions">
  ...
  <When Condition="$(TargetFrameworkIdentifier) == 'Windows'">
    <Choose>
      <When Condition="$(TargetPlatformVersion) == 'v8.0'"></When>
      <Otherwise>
        <ItemGroup>
          <Reference Include="System.Net.Http.Extensions">
  ...
  <When Condition="$(TargetFrameworkIdentifier) == 'WindowsPhoneApp'">
    <Choose>
      <When Condition="$(TargetPlatformVersion) == 'v8.1'"></When>
      <Otherwise>
        <ItemGroup>
          <Reference Include="System.Net.Http.Extensions">
  ...
  <When Condition="$(TargetFrameworkIdentifier) == 'Silverlight'">
    <Choose>
      <When Condition="$(SilverlightVersion) == 'v4.0'"></When>
      <Otherwise>
        <ItemGroup>
          <Reference Include="System.Net.Http.Extensions">
            <HintPath>..\..\..\Microsoft.Net.Http\lib\portable-net40+sl4+win8+wp71+wpa81\System.Net.Http.Extensions.dll</HintPath>
