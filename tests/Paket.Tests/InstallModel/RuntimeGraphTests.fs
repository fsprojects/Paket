      ...
      "MyDependency": {
        ...
        let graph =
            [ "MyDependency", "3.2.0", [], RuntimeGraph.Empty
              ...
              "MyDependency", "4.0.0", [], RuntimeGraphParser.readRuntimeGraph ridjson
...
NUGET
  remote: http://www.nuget.org/api/v2
    MyDependency (4.0)
    MyRuntimeDependency (4.0.1) - isRuntimeDependency: true""" |> trimAndNormalizeLines

        let depsFile = DependenciesFile.FromSource("""
