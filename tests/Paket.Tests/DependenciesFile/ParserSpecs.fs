...
let ``should read empty config``() = 
    ...
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Strict |> shouldEqual false
...
let ``should read strict config``() = 
    ...
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Strict |> shouldEqual true
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Redirects |> shouldEqual false
...
let ``should read config with redirects``() = 
    ...
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Strict |> shouldEqual false
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Redirects |> shouldEqual true
...
let ``should read content none config``() = 
    ...
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.OmitContent |> shouldEqual (Some true)
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.CopyLocal |> shouldEqual None
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.ImportTargets |> shouldEqual None
...
let ``should read config with specific framework``() = 
    ...
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.OmitContent |> shouldEqual None
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.CopyLocal |> shouldEqual None
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.ImportTargets |> shouldEqual None
...
let ``should read no targets import config``() = 
    ...
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.ImportTargets |> shouldEqual (Some false)
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.CopyLocal |> shouldEqual (Some false)
    cfg.Groups.[NormalizedGroupName Constants.MainDependencyGroup].Options.Settings.OmitContent |> shouldEqual None
