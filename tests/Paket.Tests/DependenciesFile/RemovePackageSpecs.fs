...
nuget Rx-Main ~> 2.0
nuget FAKE = 1.1
nuget SignalR = 3.3.2"""  |> trimAndNormalizeLines
...
nuget SignalR = 3.3.2"""  |> trimAndNormalizeLines
        ...
        cfg |> shouldEqualNormalized expected
...
nuget Castle.Windsor-log4net ~> 3.2
nuget Castle.Windsor ~> 3.2"""  |> trimAndNormalizeLines
...
nuget Castle.Windsor-log4net ~> 3.2"""  |> trimAndNormalizeLines
        ...
        cfg |> shouldEqualNormalized config
...
nuget Castle.Windsor-log4net ~> 3.2
group Build
nuget xUnit"""     |> trimAndNormalizeLines
...
nuget Castle.Windsor ~> 3.2"""  |> trimAndNormalizeLines
        ...
        let expected = """
source http://www.nuget.org/api/v2"""  |> trimAndNormalizeLines
...
group Test
http http://www.fssnip.net/1n decrypt.fs"""  |> trimAndNormalizeLines
