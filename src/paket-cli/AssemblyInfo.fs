...
[<assembly: AssemblyTitleAttribute("paket-cli")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "paket-cli"
    ...
    let [<Literal>] AssemblyVersion = "5.176.1"
    let [<Literal>] AssemblyFileVersion = "5.176.1"
    let [<Literal>] AssemblyInformationalVersion = "5.176.1"
