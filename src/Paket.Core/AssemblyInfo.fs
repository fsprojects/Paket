...
[<assembly: AssemblyInformationalVersionAttribute("5.182.0-alpha001")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "5.182.0"
    let [<Literal>] AssemblyFileVersion = "5.182.0"
    let [<Literal>] AssemblyInformationalVersion = "5.182.0-alpha001"
