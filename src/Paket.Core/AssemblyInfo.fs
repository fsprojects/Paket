...
[<assembly: AssemblyInformationalVersionAttribute("5.4.3")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "5.4.3"
    let [<Literal>] AssemblyFileVersion = "5.4.3"
    let [<Literal>] AssemblyInformationalVersion = "5.4.3"
