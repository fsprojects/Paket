...
let simplifyDependenciesFile (dependenciesFile : DependenciesFile, flatLookup, interactive) = attempt {
...
let simplifyReferencesFile (refFile, flatLookup, interactive) = attempt {
...
let simplify interactive environment = attempt {
