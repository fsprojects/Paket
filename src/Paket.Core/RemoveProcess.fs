...
let private remove removeFromProjects dependenciesFileName groupName (package: PackageName) force installAfter = 
    ...
    if installAfter then
        ...
        InstallProcess.Install(InstallerOptions.CreateLegacyOptions(force, false, false, false, SemVerUpdateMode.NoRestriction, false, false, [], []), false, dependenciesFile, lockFile, updatedGroups)
