...
let private remove removeFromProjects dependenciesFileName groupName (package: PackageName) force hard installAfter = 
    ...
    if installAfter then
        ...
        InstallProcess.Install(InstallerOptions.CreateLegacyOptions(force, hard, false, false, SemVerUpdateMode.NoRestriction, false), false, dependenciesFile, lockFile, updatedGroups)
