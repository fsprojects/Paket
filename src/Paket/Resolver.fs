        ...
        | Ok dependency -> 
            ...
            | _ ->
                ...
                if versions = [] then
                    ...
                    |> failwithf "No package found which matches %s %A on %A.%sVersion available:%s  %s" originalPackage.Name (originalPackage.VersionRange.ToString()) originalPackage.Sources Environment.NewLine Environment.NewLine
