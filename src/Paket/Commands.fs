...
type PackArgs =
    ...
    | [<CustomCommandLine("custom-version")>] CustomVersion of templateId:string * version:string
...
with
    interface IArgParserTemplate with
        member this.Usage =
            ...
            | CustomVersion(_) -> "Specifies a version number for template with specified id."
