...
The `paket.dependencies` file is used to specify rules regarding your application's dependencies. It contains all dependencies from all projects in the solution, while [`paket.references` file] specifies dependencies only for particular project.
