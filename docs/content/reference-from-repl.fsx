...
As first step we need to download and reference the latest paket tool.
This boilerplate code allows F# scripts to work self-contained without an installed paket.exe.
Alternativly you can just reference any paket.exe that you have on your system.
*)
...
Now we need open the Paket namespace and to tell Paket which [`paket.dependencies`](dependencies-file.html) file to use.
